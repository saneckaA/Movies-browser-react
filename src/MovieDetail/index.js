                ...
                >
                    ...
                    <Rating background>
                        <IconAndAverage>
                            ...
                            <AverageBcg><span>{movie.vote_average}</span> / 10</AverageBcg>
                        </IconAndAverage>
            ...
            <InfoBar >
                <Details>
                    ...
                    <Informations>
                        ...
                        <Year>{movie.release_date ? movie.release_date.slice(0, 4) : undefined}</Year>
                        <ProductionAndDate>
                            <Production><span>Production:</span> {movie.production_countries ? movie.production_countries.map(country => country.name).join(', ') : undefined} </Production>
                        ...
                        <Rating>
                            ...
                            <Average ><span>{movie.vote_average}</span> / 10</Average>
